package br.com.esales.rest.product.swagger;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.esales.rest.product.controller"))
                .build()
                .apiInfo(apiInfo())
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Microservices edienterprise")
                .description("Microservices edienterprise")
                .version("1.0")
